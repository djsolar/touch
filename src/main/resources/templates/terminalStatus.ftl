        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="/terminal/terminalStatus"><i class="fa fa-bar-chart-o fa-3x"></i>终端监控</a>
                    </li>
                    <li>
                        ...
                        <div class="terminal-operation">
                            <div>
                                <button class="btn btn-info">
                                    <i class="fa fa-download"></i> 下载状态
                                </button>
                                <button class="btn btn-info">
                                    <i class="fa fa-list"></i> 终端节目
                                </button>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-info">终端操作</button>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#">音量</a></li>
                                        <li><a href="#">自动开关机设置</a></li>
                                        <li><a href="#">更新终端软件</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
