package com.twinflag.touch.socket;
...
import com.twinflag.touch.utils.ZLibUtil;
import org.springframework.stereotype.Component;

@Component
public class PublishUtil{

	public  boolean publishTask(JSONPObject json, String ip) {
		Socket socket = null;
...
//			sizes[0] = (byte)((0xff000000 & size) >> 24);
            ...
            buffer = new byte[prefixArray.length + midArray.length];
            System.arraycopy(prefixArray, 0, buffer, 0, 4);
            System.arraycopy(midArray, 0, buffer, 4, 4);
